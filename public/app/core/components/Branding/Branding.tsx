...
export const LoginLogo: FC<BrandComponentProps> = ({ className }) => {
  ...
  return (
    <>
      {/* <img className={cx(className, maxSize)} src="public/img/grafana_icon.svg" alt="ED fems" /> */}
      {/* <div className="logo-wordmark" /> */}
      <img className={cx(className, maxSize)} src="public/img/EDfems_icon.svg" alt="ED fems" />
      <p>EnergyDoctor FEMS</p>
    </>
  );
};
